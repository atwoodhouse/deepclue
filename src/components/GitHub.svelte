<div>
  <a href="https://github.com/atwoodhouse/deepclue" target="_blank" rel="noreferrer">
    <p>This project is open source.<br />Written in only 4 evenings, so don't be too hard on me.<br />Feel free to steal everything!</p>
